...
const resources: { title: string; desc: string; icon: string; link: string; tag: string }[] = []
...
export default function PortalPage() {
  ...
  const baseTabs = [
    ...
    { key:'impact'    as Tab, label:'Log a Win',          icon:'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
                ...
                {nextEvent ? (
                  <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="flex-grow px-6 py-7 flex flex-col justify-between">
                      ...
                      {nextEvent.location && (
                        <a
                          href={`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(nextEvent.location)}`}
                          target="_blank" rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 mt-5 px-4 py-2 bg-jc-black text-white text-xs font-black uppercase tracking-widest hover:bg-jc-red transition-colors"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="grid sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
              ...
              <div className="bg-white border border-jc-gray-mid p-6 flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-jc-gray-dark text-xs font-bold uppercase tracking-widest bg-jc-gray px-2 py-1">Handbook</span>
                </div>
                <h3 className="text-jc-black font-black text-base mb-3">Member Handbook</h3>
                <div className="flex flex-col gap-2 flex-grow">
                  {memberDocs.map(d=>(
                    d.link ? (
                      <a key={d.label} href={d.link} target="_blank" rel="noopener noreferrer"
                        ...
                        <span className="text-jc-black group-hover/link:text-jc-red text-sm font-bold transition-colors">{d.label}</span>
                        <svg className="w-3.5 h-3.5 text-jc-red flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                        </svg>
                      </a>
                    ) : (
                      <div key={d.label} className="flex items-center justify-between px-3 py-2.5 border border-jc-gray-mid opacity-40 cursor-not-allowed">
                        <span className="text-jc-black text-sm font-bold">{d.label}</span>
              ...
              <div className="bg-white border border-jc-gray-mid p-6 flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-jc-gray-dark text-xs font-bold uppercase tracking-widest bg-jc-gray px-2 py-1">PDFs</span>
                </div>
                <h3 className="text-jc-black font-black text-base mb-3">Packet PDFs</h3>
                <div className="flex flex-col gap-2 flex-grow">
                  {packetPdfs.map(p=>(
                    <a key={p.label} href={p.link} target="_blank" rel="noopener noreferrer"
                      className="flex items-center justify-between px-3 py-2.5 border border-jc-gray-mid hover:border-jc-red hover:text-jc-red transition-colors group/link">
                      <span className="text-jc-black group-hover/link:text-jc-red text-sm font-bold transition-colors">{p.label}</span>
                      <svg className="w-3.5 h-3.5 text-jc-red flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                      </svg>
                    </a>
