...
const resources = [
  ...
  { title:'Hospitality Packet PDF',         desc:'Share with potential hospitality partners.',                    icon:'M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', link:'/Junior Council Hospitality Packet - Snowball 2023.pdf',       tag:'PDF'        },
  { title:'Sponsorship Opportunities',      desc:'Overview of all sponsorship tiers and benefits.',               icon:'M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', link:'/Junior Council Sponsorship Opportunities 2023.pdf',           tag:'PDF'        },
