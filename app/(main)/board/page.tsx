...
const boardMembers: BoardMember[] = [
  ...
  },
  {
    ...
    bio: 'Marisa Stefani holds a Master\'s in Accounting from the University of Illinois Urbana-Champaign and is a CPA and Manager of Accounting & Projects at CF Industries, the world\'s largest ammonia producer. In her third year as a Junior Council member, Marisa is thrilled to serve on the board as Corporate Director. A committed fitness enthusiast with over 1,400 barre classes completed, she also ran the 2014 Chicago Marathon and studied abroad in Belgium. In her free time, Marisa enjoys golfing, traveling, trying new restaurants, and spending time with friends and family.',
